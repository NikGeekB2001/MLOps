...
YC_DP_FOLDER_ID = "b1gsp3n71qmcqf3delc5"
YC_DP_SUBNET_ID = "e2lnepc7mkbnrh1ik65o"
YC_DP_SA_ID = "ajem60lkmj5o6dqcpu7n"
YC_DP_AZ = "ru-central1-b"
YC_DP_SSH_PUBLIC_KEY = Variable.get("SSH_PUBLIC")
YC_DP_GROUP_ID = "enp24osvp7cvbgvs6tec"


# Settings for S3 buckets
YC_INPUT_DATA_BUCKET = "otus-dataproc-bucket-1/airflow/"  # YC S3 bucket for input data
YC_SOURCE_BUCKET = "otus-dataproc-bucket-1"  # YC S3 bucket for pyspark source files
YC_DP_LOGS_BUCKET = (
    "dataconveyor2/airflow_logs/"  # YC S3 bucket for Data Proc cluster logs
)
...
ycSA_connection = Connection(
    ...
    extra={
        ...
        "extra__yandexcloud__service_account_json_path": Variable.get(
            "DP_SA_PATH"
        ),  # путь к вашему файлу с секретками сервисного аккаунта
    },
)
...
with DAG(
    ...
    poke_spark_processing = DataprocCreatePysparkJobOperator(
        ...
        main_python_file_uri=f"s3a://{YC_SOURCE_BUCKET}/scripts/credit card fraud detection.ipynb",  # ваш скрипт, выполняющий очистку данных
        connection_id=ycSA_connection.conn_id,
        dag=ingest_dag,
    )
